...
export const DEMO_STOK_CHAIN: StokChainStep[] = [
  ...
  },
  {
    ...
    href: "/finance/persediaan/penyesuaian-persediaan/adj-2026-012",
    status: "done",
  },
  {
    id: "ajuan",
...
export const DEMO_CHECKLIST = [
  ...
  { id: "d6", group: "Finance", label: "Penyesuaian stok → jurnal otomatis", href: "/finance/persediaan/penyesuaian-persediaan" },
  { id: "d7", group: "Finance", label: "Faktur penjualan → hutang/piutang", href: "/finance/penjualan/faktur-penjualan" },
