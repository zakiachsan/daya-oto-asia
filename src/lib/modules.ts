...
export const MODULES: ModuleDef[] = [
  {
    ...
    menus: [
      ...
      { href: "/operasional/surat-jalan", label: "Surat Jalan" },
  ...
  },
  {
    ...
    menus: [
      ...
      { href: "/operasional/po", label: "PO & Penerimaan (Ops)", section: "Operasional Terhubung" },
      { href: "/finance/surat-jalan", label: "Surat Jalan (View)" },
      { href: "/finance/laporan/rekap-pemakaian-cabang", label: "Rekap Pemakaian Cabang" },
      { href: "/finance/penjualan/proses-invoice", label: "Proses Invoice", section: "Penjualan" },
...
export const MOBILE_MODULE: ModuleDef = {
  ...
  menus: [
    ...
    { href: "/app/tukar-nota", label: "Tukar-Tambah Nota" },
    { href: "/app/terima-barang", label: "Terima Barang" },
    { href: "/app/notifikasi", label: "Notifikasi" },
