...
export default function AppTransaksiPage() {
  ...
  const myTrx = all.filter((t) => t.tinter === "Andi Wijaya");
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {myTrx.map((t) => (
          <Link key={t.id} href={`/app/transaksi/${t.id}`} className="block bg-white rounded-xl p-3.5 border border-slds-border">
