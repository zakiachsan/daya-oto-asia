...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "Supervisor cocokkan OPB vs nota cetak vs pemakaian stok. Selisih > 0 = perlu review. Deteksi leakage: stok habis tapi OPB belum terbentuk, atau nota cetak > OPB.",
    links: [{ href: "/operasional/rekonsiliasi", label: "Rekonsiliasi OPB" }],
  },
  {
    title: "4. WMS — PO, Distribusi, Stock Opname",
    body: "PO ke pabrik → Goods Received → stok pusat. Distribusi ke cabang. Stock opname: tinter timbang gram, supervisor rekonsiliasi toleransi ±5g.",
    links: [
